//! Cross-crate type-level conformance for the four protocol Account and AccountFactory implementations. These tests construct each public factory, verify the shared traits remain object-safe, and make sure the factories still match the SyncEngine::attach signature without opening accounts or exercising live network behavior.
