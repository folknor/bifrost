...
mod sync {
    use bifrost_smtp::{Message, SendmailTransport, Transport};
...
mod tokio_1 {
    use bifrost_smtp::{AsyncSendmailTransport, AsyncTransport, Message, Tokio1Executor};
...
mod asyncstd_1 {
    use bifrost_smtp::{AsyncSendmailTransport, AsyncStd1Executor, AsyncTransport, Message};
