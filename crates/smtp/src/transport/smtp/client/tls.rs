...
#[cfg_attr(
    ...
    deprecated(
        note = "starting from bifrost_smtp v0.12 `Tls` won't be available when none of the TLS backends are enabled"
    )
)]
#[cfg_attr(
    docsrs,
...
pub enum Tls {
    ...
    ///
    /// Bifrost SMTP will try to upgrade to a TLS-secured connection but will fall back
    ...
    /// causing Bifrost SMTP to believe the server only supports plaintext connections.
    #[cfg(any(feature = "native-tls", feature = "rustls", feature = "boring-tls"))]
    #[cfg_attr(
        docsrs,
        doc(cfg(any(feature = "native-tls", feature = "rustls", feature = "boring-tls")))
    ...
    ///
    /// Bifrost SMTP will upgrade plaintext TCP connections to TLS before transmitting
    ...
    ///
    /// Bifrost SMTP connects to the server and immediately performs a TLS handshake.
...
#[cfg_attr(
    not(any(feature = "native-tls", feature = "rustls", feature = "boring-tls")),
    deprecated(
        note = "starting from bifrost_smtp v0.12 `CertificateStore` won't be available when none of the TLS backends are enabled"
    )
)]
#[cfg_attr(
    docsrs,
...
#[cfg_attr(
    not(any(feature = "native-tls", feature = "rustls", feature = "boring-tls")),
    deprecated(
        note = "starting from bifrost_smtp v0.12 `TlsParameters` won't be available when none of the TLS backends are enabled"
    )
)]
#[cfg_attr(
    docsrs,
...
#[cfg_attr(
    not(any(feature = "native-tls", feature = "rustls", feature = "boring-tls")),
    deprecated(
        note = "starting from bifrost_smtp v0.12 `TlsParametersBuilder` won't be available when none of the TLS backends are enabled"
    )
)]
#[cfg_attr(
    docsrs,
...
#[cfg_attr(
    not(any(feature = "native-tls", feature = "rustls", feature = "boring-tls")),
    deprecated(
        note = "starting from bifrost_smtp v0.12 `Certificate` won't be available when none of the TLS backends are enabled"
    )
)]
#[cfg_attr(
    docsrs,
...
#[cfg_attr(
    not(any(feature = "native-tls", feature = "rustls", feature = "boring-tls")),
    deprecated(
        note = "starting from bifrost_smtp v0.12 `Identity` won't be available when none of the TLS backends are enabled"
    )
)]
#[cfg_attr(
    docsrs,
