...
- Never suggest or use the `Workflow` tool (multi-agent orchestration / "ultracode"). Bifrost orchestration goes through the spec-loop in `reference/orchestrate.md`.
